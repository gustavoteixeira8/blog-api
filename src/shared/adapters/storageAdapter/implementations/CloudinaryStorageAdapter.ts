...
import { Filetype, StorageAdapterProtocol, StorageResponse } from '../StorageAdapterProtocol';
import { logger } from '@shared/log';

export class CloudinaryStorageAdapter implements StorageAdapterProtocol {
